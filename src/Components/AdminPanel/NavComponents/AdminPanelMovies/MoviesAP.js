...
const MoviesAP = () => {
    ...
    const [adminPanelMovies, setAdminPanelMovies] = useState(null);

    const [searchMoviesAdminPanel, setSearchMoviesAdminPanel] = useState('');
    ...
    const addMovieToBlackList = (id) => {
        ...
        if (blackListMovieIndex !== -1) {
            ...
            const copyAdminPanelMovies = [...adminPanelMovies];
            const blackListMovie = copyAdminPanelMovies.splice(blackListMovieIndex, 1);
